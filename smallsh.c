/*SMALLSH WRITTEN BY COULBY NGUYEN 932-439-525
 * THIS CODE MIMICKS A BASH SHELL WITH 3 BUILT IN COMMANDS
 * STATUS CD AND EXIT EVERYTHING ELSE IS JUST EXECUTED WITH
 * EXECVP*/
